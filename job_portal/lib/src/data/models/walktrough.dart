...
final List<AWalkThroughModel> modal = [
  AWalkThroughModel(
    heading: 'SKILL',
    title: 'Earn money for your trade',
    subtitle: 'if you have a particular trade or skill, you can use this platform to connect with potential clients who are willing to pay for your services. ',
    image: 'assets/images/walk/p1.jpg',
    progress: 0.33,
  ),
  AWalkThroughModel(
    heading: 'SKILL',
    title: 'Showcase your skills and get paid',
    subtitle: 'Ever wondered what you can do with a couple of minutes, hours or days of spare time? Have a skill you’d like to showcase and get financially appreciated for? Or just simply ',
    image: 'assets/images/walk/p3.jpg',
    progress: 0.66,
  ),
  AWalkThroughModel(
    heading: 'SKILL',
    title: 'Skill recognizes and appreciates you',
    subtitle: 'showcasing your skills and using them to help others, you can feel appreciated and valued. ',
    image: 'assets/images/walk/p2.jpg',
    progress: 1,
  ),
];
...
List<LanguageDataModel> languageList() {
  return [
    LanguageDataModel(id: 1, name: 'English', languageCode: 'en', fullLanguageCode: 'en-US', flag: 'images/flag/ic_uk.png'),
